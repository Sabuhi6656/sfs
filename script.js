...
const translations = {
    az: {
        ...
        'about.description': 'Maliyyə, Mühasibatlıq və Audit sahəsində peşəkar xidmət göstərən konsalting şirkəti olaraq fəaliyyətdəyik. SUMMİT FİNANCE SOLUTİONS MMC 04.04.2025 tarixində yaradılmışdır. Yarandığı tarixdən bu günə qədər bir sıra böyük dövriyyəli şirkətlərə xidmət göstərmiş və xərclərin optimizasiyası, vergi riskləri və maliyyə riskləri barədə rəhbərliklərə öz tövhəsini vermişdir.',
        'about.mission.title': 'Missiyamız',
        'about.mission.description': 'Missiyamız – çalışdığımız şirkətlərdə yüksək maliyyə təhlilləri edərək onların inkişafına töhvə verməkdir. Şirkətlərdə maliyyə təhlilləri ən önəmli faktorlardan biridir. Belə ki, bir sıra şirkətlər maliyyə təhlilləri nəticəsində həm xərci optimizasiya edə bilir və eləcə də gələcəkdə yarana biləcək risklərin qarşısını almaq rahat olur. Biz konsalting şirkəti olaraq bu təhlilləri, büdcələrin tərtib olunması və sonrakı proseslərdə onların audit olunmasını təklif edirik. Kənarlaşmalar barədə aylıq və ya rəhbərliyin istədiyi vaxtlarda maliyyə arayışları təqdim edirik ki, şirkətdə baş verən proseslər daha şəffaf görünsün.',
